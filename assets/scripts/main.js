  ...
  if('serviceWorker' in navigator){
    ...
    window.addEventListener('load', () => {
      ...
      .catch((error) => {
        ...
        console.log('SeriveWorker registration failed: ', error);
      });
    });
  }else {
    //Not supported
    console.log('Serive Workers are not supported in this browser.');
  }
  ...
  //            will be in the catch portion.
        try {
          ...
          if(recipes.length == RECIPE_URLS.length){
            // Save te recipes to storage using the funciton provided
